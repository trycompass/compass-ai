...
- `ANTHROPIC_API_KEY`: The API key for the Claude 3.5 Sonnet.
- `PPLX_API_KEY`: The API key for Perplexity API (used for web searches).
...
[API routes](https://nextjs.org/docs/api-routes/introduction) can be accessed on [http://localhost:3000/api/compass](http://localhost:3000/api/compass). This endpoint can be edited in `pages/api/compass.js`.
